...
-- Insertar una fila con todos los valores especificados
INSERT INTO Productos (producto_id, nombre, precio, stock)
VALUES (1, 'Laptop Gaming', 1200.00, 5);

-- Insertar otra fila, el orden de las columnas debe coincidir con el de los valores
INSERT INTO Productos (nombre, stock, precio, producto_id)
VALUES ('Monitor Curvo', 10, 350.50, 2);

-- Insertar una fila omitiendo una columna con valor DEFAULT (stock)
...
-- Insertar múltiples filas en una sola sentencia (sintaxis común en muchos DBMS)
INSERT INTO Productos (producto_id, nombre, precio, stock)
VALUES
...
-- Insertar datos desde otra tabla (si tuvieras una tabla temporal, por ejemplo)
